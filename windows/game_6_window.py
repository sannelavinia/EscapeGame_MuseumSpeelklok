...
def game_6_window():
    ...
    # background music
    m.pygame.mixer.music.load("Assets/sounds/game_6.wav")
    m.pygame.mixer.music.play(-1)  # play the music in an infinite loop

    keyboard = k.Keyboard(1000, 300)  # the input keyboard
    keyboard_x = 1000
    ...
    while True:
        ...
        m.SCREEN.blit(m.background_game_6, (0, 0))
        if(keyboard_x > 1000):
            keyboard_x -= 1
