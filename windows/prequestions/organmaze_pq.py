...
class OrganMaze: 
    ...
    def __init__(self, last_clicked_letter_button=-1, correct_corresponding_organ=-1, 
        ...
        # initialize static locations of buttons
    ...
    def organmaze_pq(self):
        ...
        location_organ1_button = b.Button(self.bellow_transparent, self.bellow_transparent, self.bellow_transparent, \
            location_organ1[0], location_organ1[1], 240, 160)
        location_organ2_button = b.Button(self.bellow_transparent, self.bellow_transparent, self.bellow_transparent, \
            location_organ2[0], location_organ2[1], 180, 120)
        location_organ3_button = b.Button(self.bellow_transparent, self.bellow_transparent, self.bellow_transparent, \
            location_organ3[0], location_organ3[1], 170, 120)
        location_organ4_button = b.Button(self.bellow_transparent, self.bellow_transparent, self.bellow_transparent, \
            location_organ4[0], location_organ4[1], 170, 150)
        location_organ5_button = b.Button(self.bellow_transparent, self.bellow_transparent, self.bellow_transparent, \
            location_organ5[0], location_organ5[1], 240, 160)
        location_organ6_button = b.Button(self.bellow_transparent, self.bellow_transparent, self.bellow_transparent, \
        ...
        # self.buttons_dict = {location_A_button: location_organ6_button, location_B_button: location_organ4_button, \
        #     location_C_button: location_organ2_button, location_D_button: location_organ1_button,
        #     location_E_button: location_organ5_button, location_F_button: location_organ3_button}
