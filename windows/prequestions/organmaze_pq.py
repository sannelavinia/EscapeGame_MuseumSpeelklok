...
class OrganMaze:
    def __init__(self, last_clicked_letter_button=-1, correct_corresponding_organ=-1):
        ...
        self.bellow_transparent = m.pygame.transform.scale(
            m.transparent_box, (250, 120)
        )

        ## Create invisible buttons for each pressable object ##
        # Buttons of letter locations are set as class variables
        self.location_A_button = b.Button(
            self.bellow_transparent,
            self.bellow_transparent,
            self.bellow_transparent,
            self.location_A[0],
            self.location_A[1],
        ...
        self.location_B_button = b.Button(
            self.bellow_transparent,
            self.bellow_transparent,
            self.bellow_transparent,
            self.location_B[0],
        ...
        self.location_C_button = b.Button(
            self.bellow_transparent,
            self.bellow_transparent,
            self.bellow_transparent,
            self.location_C[0],
        ...
        self.location_D_button = b.Button(
            self.bellow_transparent,
            self.bellow_transparent,
            self.bellow_transparent,
            self.location_D[0],
        ...
        self.location_E_button = b.Button(
            self.bellow_transparent,
            self.bellow_transparent,
            self.bellow_transparent,
            self.location_E[0],
        ...
        self.location_F_button = b.Button(
            self.bellow_transparent,
            self.bellow_transparent,
            self.bellow_transparent,
            self.location_F[0],
        ...
        # Buttons of letter locations are set as class variables
        self.location_organ1_button = b.Button(
            self.bellow_transparent,
            self.bellow_transparent,
            self.bellow_transparent,
            self.location_organ1[0],
            self.location_organ1[1],
            240,
            160,
        )
        self.location_organ2_button = b.Button(
            self.bellow_transparent,
            self.bellow_transparent,
            self.bellow_transparent,
            self.location_organ2[0],
            self.location_organ2[1],
            180,
            120,
        )
        self.location_organ3_button = b.Button(
            self.bellow_transparent,
            self.bellow_transparent,
            self.bellow_transparent,
            self.location_organ3[0],
            self.location_organ3[1],
            170,
            120,
        )
        self.location_organ4_button = b.Button(
            self.bellow_transparent,
            self.bellow_transparent,
            self.bellow_transparent,
            self.location_organ4[0],
            self.location_organ4[1],
            170,
            150,
        )
        self.location_organ5_button = b.Button(
            self.bellow_transparent,
            self.bellow_transparent,
            self.bellow_transparent,
            self.location_organ5[0],
            self.location_organ5[1],
            240,
            160,
        )
        self.location_organ6_button = b.Button(
            self.bellow_transparent,
            self.bellow_transparent,
            self.bellow_transparent,
            self.location_organ6[0],
            self.location_organ6[1],
            170,
            150,
        )
        ...
        self.buttons_dict = {
            self.location_A_button: self.location_organ6_button,
            self.location_B_button: self.location_organ4_button,
            self.location_C_button: self.location_organ2_button,
            self.location_D_button: self.location_organ1_button,
            self.location_E_button: self.location_organ5_button,
            self.location_F_button: self.location_organ3_button,
        }
    ...
    def organmaze_pq(self):
        ...
        organ_maze = pygame.transform.scale(
            m.organ_maze, (m.WIDTH * 0.7, m.HEIGHT * 0.7)
        )
        ...
        prequestion_6_explanation1 = m.MagdaClean_font_30.render(
            explanation_text1, True, m.green_color
        )
        prequestion_6_explanation1_rect = prequestion_6_explanation1.get_rect(
            center=(m.WIDTH / 2, m.HEIGHT / 10)
        )
        prequestion_6_explanation2 = m.MagdaClean_font_30.render(
            explanation_text2, True, m.green_color
        )
        prequestion_6_explanation2_rect = prequestion_6_explanation2.get_rect(
            center=(m.WIDTH / 2, m.HEIGHT / 8)
        )
        prequestion_6_explanation3 = m.MagdaClean_font_30.render(
            explanation_text3, True, m.green_color
        )
        prequestion_6_explanation3_rect = prequestion_6_explanation3.get_rect(
            center=(m.WIDTH / 2, m.HEIGHT / 6)
        )
        ...
        while True:
            ...
            if (
                self.last_clicked_letter_button != -1
                and self.correct_corresponding_organ != -1
                and (self.last_clicked_letter_button in self.buttons_dict)
                and (self.last_clicked_letter_button not in self.correct_buttons_dict)
            ):
                m.SCREEN.blit(
                    m.orange_circle,
                    (
                        self.last_clicked_letter_button.x_pos - 37.5,
                        self.last_clicked_letter_button.y_pos - 37.5,
                    ),
                )
            ...
            for event in m.pygame.event.get():
                ...
                if (
                    ...
                    and len(self.correct_buttons_dict) == 6
                ):
                ...
                for button in self.buttons_dict:
                    ...
                    if (
                        event.type == m.pygame.MOUSEBUTTONDOWN
                        and corresponding_organ.mouse_on_button()
                    ):
                        if corresponding_organ == self.correct_corresponding_organ:
                            ...
                            m.SCREEN.blit(
                                m.green_check,
                                (
                                    corresponding_organ.x_pos - 37.5,
                                    corresponding_organ.y_pos - 37.5,
                                ),
                            )
                ...
                if (
                    ...
                    prequestion_6_explanation1 = m.MagdaClean_font_30.render(
                        congratulatory_text1, True, m.green_color
                    )
                    prequestion_6_explanation1_rect = (
                        prequestion_6_explanation1.get_rect(
                            center=(m.WIDTH / 2, m.HEIGHT / 10)
                        )
                    )
                    prequestion_6_explanation2 = m.MagdaClean_font_30.render(
                        congratulatory_text2, True, m.green_color
                    )
                    prequestion_6_explanation2_rect = (
                        prequestion_6_explanation2.get_rect(
                            center=(m.WIDTH / 2, m.HEIGHT / 8)
                        )
                    )
                    prequestion_6_explanation3 = m.MagdaClean_font_30.render(
