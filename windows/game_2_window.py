...
def game_2_window():
    ...
    # background music
    m.pygame.mixer.music.load("Assets/sounds/game_2.wav")
    m.pygame.mixer.music.play(-1)  # play the music in an infinite loop

    keyboard = k.Keyboard(500, 300)  # the input keyboard
    keyboard_x = 500
    ...
    while True:
        ...
        m.SCREEN.blit(m.background_game_2, (0, 0))
        if(keyboard_x > 200):
            keyboard_x -= 2
