...
def game_3_window():
    ...
    # background music
    m.pygame.mixer.music.load("Assets/sounds/game_3.wav")
    m.pygame.mixer.music.play(-1)  # play the music in an infinite loop

    keyboard = k.Keyboard(200, 300)  # the input keyboard
    keyboard_x = 200
    ...
    while True:
        ...
        m.SCREEN.blit(m.background_game_3, (0, 0))
        if(keyboard_x < 1100):
            keyboard_x += 10
