...
def start_window():
    ...
    start_window_museum_logo = m.pygame.image.load(
        "Assets/images/start_window_museum_logo.png")
    start_window_museum_logo = m.pygame.transform.scale(
        start_window_museum_logo, (120, 36))
    logo = Button(start_window_museum_logo, start_window_museum_logo,
                  start_window_museum_logo, m.WIDTH - 70, m.HEIGHT - 25)
